// FILE PATH: app/(drawer)/favourites.tsx
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background.primary }]}>
      ...
      <View style={[styles.banner, { backgroundColor: colors.background.header }]}>
        <ThemedText variant="hymnTitle" onHeader>Favourite</ThemedText>
      </View>
      <View style={styles.content}>
        <ThemedText variant="uiLabel" muted>Favourites load here in Phase 4</ThemedText>
      </View>
    </View>
  );
}
