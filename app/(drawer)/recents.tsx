// FILE PATH: app/(drawer)/recents.tsx
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background.primary }]}>
      ...
      <View style={[styles.banner, { backgroundColor: colors.background.header }]}>
        <ThemedText variant="hymnTitle" onHeader>Recent</ThemedText>
      </View>
      <View style={styles.content}>
        <ThemedText variant="uiLabel" muted>Recent hymns load here in Phase 4</ThemedText>
      </View>
    </View>
  );
}
